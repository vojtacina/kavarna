      ...
      <nav className="" role="navigation">
        <div className="container mx-auto p-4 flex flex-wrap items-center md:flex-no-wrap">
          ...
          <div className="text-black">
            <p className="text-lg">Testovací stránka</p>
            <p>NextJS</p>
          </div>
          ...
          <div className="w-full md:w-auto md:flex-grow md:flex md:items-center">
            <ul className="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:mt-0 md:pt-0 md:mr-4 md:ml-auto lg:mr-8 md:border-0">
              <li>
                <a href="/" className="block px-4 py-1 md:p-2 lg:px-8">Domů</a>
              </li>
              <li>
                <a href="/" className="block px-4 py-1 md:p-2 lg:px-8">Kontakt</a>
              </li>
            </ul>
            <ul className="flex flex-col mt-4 -mx-4 pt-4 border-t md:flex-row md:items-center md:mx-0 md:mt-0 md:pt-0 md:border-0">
              <li>
                <a href="" className="block px-4 py-1 md:p-2 rounded-lg lg:px-4 bg-black text-white">CZ</a>
              </li>
              <li>
                <a href="/de" className="block px-4 py-1 md:p-2 rounded-lg lg:px-4">EN</a>
              </li>
            </ul>
          </div>
        </div>
